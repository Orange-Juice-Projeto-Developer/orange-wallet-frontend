...
function Header() {
  return (
    <header className="bg-gradient-to-b from-[rgba(19,19,19,0.4126)] to-[#323131] rounded-b-[30px] pb-7 font-roboto">
      <div className="flex justify-between items-center px-16 pt-16 pb-8">
        <div className="">
          <p className="text-base text-white">Ola, <span className="text-2xl text-white">Theodoro</span></p>
        </div>
        <div className="flex">
          <img
            className="mr-4 w-6"
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex flex-col">
            <div className="flex justify-between items-center w-[400px]">
              ...
              <img className="ml-4" src={eyeIcon} alt="Ícone de olho cortado" />
							</div>
              <img
                src={dolarIcon}
                alt="Ícone de dolar"
